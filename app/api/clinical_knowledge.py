...
@router.post("/sources", dependencies=[Depends(require_governance_mutation_enabled)], response_model=SourceRecord, status_code=201,
...
@router.post("/sources/{source_id}/submit-review", dependencies=[Depends(require_governance_mutation_enabled)], response_model=SourceRecord)
...
@router.post("/sources/{source_id}/review", dependencies=[Depends(require_governance_mutation_enabled)], response_model=SourceRecord)
...
@router.post("/ingest", dependencies=[Depends(require_governance_mutation_enabled)], responses={409: {"model": SourceConflictDetail, "description": "Canonical source metadata conflict"}})
...
@router.post("/entities/{entity_type}/{entity_id}/submit-review", dependencies=[Depends(require_governance_mutation_enabled)])
...
@router.post("/entities/{entity_type}/{entity_id}/review", dependencies=[Depends(require_governance_mutation_enabled)])
...
@router.post("/entities/{entity_type}/{entity_id}/retire", dependencies=[Depends(require_governance_mutation_enabled)])
...
@router.post("/entities/{entity_type}/{entity_id}/supersede", dependencies=[Depends(require_governance_mutation_enabled)])
